...
public:
    ...
    static unsigned int lerp(H2DE_Engine* engine, H2DE_Lerp_T origin, H2DE_Lerp_T destination, unsigned int duration, H2DE_Easing easing, const std::function<void(H2DE_Lerp_T)>& update, const std::function<void()>& completed, bool pauseSensitive = true) {
    ...
    static unsigned int lerp(H2DE_Engine* engine, const H2DE_ColorRGB& origin, const H2DE_ColorRGB& destination, unsigned int duration, H2DE_Easing easing, const std::function<void(H2DE_ColorRGB)>& update, const std::function<void()>& completed, bool pauseSensitive = true) {
