...
/**
 * @file H2DE_single_surface_object.h
 * @brief Defines H2DE_SingleSurfaceObject, a base class for objects with one type of drawable surface.
 * 
 * This file contains the H2DE_SingleSurfaceObject class, which inherits from H2DE_Object and provides
 * functionalities to manage a collection of surfaces (textures, sprites, or colors) for game objects.
 * 
...
/**
 * @class H2DE_SingleSurfaceObject
 * @brief Base class for objects that hold one type of drawable surface.
 * 
 * H2DE_SingleSurfaceObject manages:
 * - A collection of surfaces (texture, sprite, or color) identified by unique names
 * - Adding, removing, and retrieving surfaces safely
 * - Checking existence of surfaces by name
