...
public:
    ...
    inline H2DE_Time getTime() const { return timerObjectData.time; }
    inline uint8_t getHours() { return timerObjectData.time.hours; }
    inline uint8_t getMinutes() { return timerObjectData.time.minutes; }
    inline uint8_t getSeconds() { return timerObjectData.time.seconds; }
